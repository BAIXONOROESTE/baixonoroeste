...
export const pushCountToOmie = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) => {
    ...
    // E-mail instantâneo de contagem (individual/família) removido — o resumo
    // diário das 5h agora consolida essas informações. O e-mail de fechamento
    // de inventário continua sendo disparado em closeInventory.
